...
def generatePuns(phrase, topic):
	relatedWords = getRelBasic(topic)
	relatedWordsArpa = []
	phraseArpa = []
	...
	print(punsListStrings)
	punsList = getPhonScores.sortPuns(getPhonScores.getPhonScores(punsListStrings))

	return punsList

print(str(generatePuns("elements of style", "happy")))import csv
import nltk
import getPhonScores
from getRelated import getRelBasic
from syllabify import syllabify
...
print(str(generatePuns("elements of style", "happy")))
